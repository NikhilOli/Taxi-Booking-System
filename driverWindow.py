...
class DriverWindow:
    ...
    def __init__(self,driverWindow,username):
        self.driverWindow = driverWindow
        self.driverWindow.title("Driver Dashboard")
        self.driverWindow.geometry('1366x768')
        self.driverWindow.state('zoomed')
        self.driverWindow.config(background='#dcdcdc')


    #========Header=========================  
        self.header = tk.Frame(self.driverWindow, bg='#fff')
        ...
        self.heading = ttk.Label(self.driverWindow,background='#fff', text=f'Welcome Back, {username}', font=("Trebuchet MS", 20),)
        ...
        self.sidebar = ttk.Frame(self.driverWindow, style='TFrame')
        ...
        self.completedtripsBtn = tk.Button(self.sidebar, fg='#797979', text='Ride Completed', activebackground='#fff', background='#fff', bd=0, font=('Trebuchet MS', 14,))
        ...
        self.completedtripsBtn = tk.Button(self.sidebar, fg='#797979', text='Ride Cancelled', activebackground='#fff', background='#fff', bd=0, font=('Trebuchet MS', 14,))
        ...
        #TOP head Frames 
        self.topframe1 = tk.Frame(self.driverWindow, bg='#fff')
        ...
        self.topframe2 = tk.Frame(self.driverWindow, bg='#fff')
        ...
        self.topframe3 = tk.Frame(self.driverWindow, bg='#fff')
        ...
        self.topframe4 = tk.Frame(self.driverWindow, bg='#fff')
        ...
        self.inputFrame = tk.Frame(self.driverWindow, bg='#fff')
    ...
    def complete_booking(self):
        ...
        # self.treeviewframe = tk.Frame(self.driverWindow, highlightbackground='#87CEEB', highlightthickness=2, bg='#fff')
    ...
    def logout(self,):
        self.driverWindow.destroy()
        import login
    # Create  TTk widgets    
    
if __name__ == "__main__":
    driverWindow = tk.Tk()
    app = DriverWindow(driverWindow)
